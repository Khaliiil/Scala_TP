...
object CacheQuery {
  def queryPairOfActors(cache_movies: collection.mutable.Map[Int, Set[(Int, String)]] , cache_actor_indirect: collection.mutable.Map[Int, (String, String)]): Set[((String, String), (String, String))] = {
    ...
    if(pairOfActors.isEmpty){
      return Set[((String, String), (String, String))]()
    }
